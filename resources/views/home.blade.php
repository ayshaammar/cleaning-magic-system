@extends('layouts.app', ['title' => 'Nova Clinic - الرئيسية'])
    ...
    <div class="row align-items-center g-4">
        <div class="col-lg-6">
            ...
            <div class="d-flex flex-wrap gap-2">
                @guest
                    <a class="btn btn-primary btn-lg rounded-pill px-4" href="{{ route('register') }}">
                        ابدأ الآن <i class="bi bi-arrow-left-short"></i>
                    </a>
                    <a class="btn btn-outline-dark btn-lg rounded-pill px-4" href="{{ route('login') }}">
                        تسجيل دخول
                    </a>
                @endguest
                @auth
                    <a class="btn btn-primary btn-lg rounded-pill px-4" href="{{ route('dashboard') }}">
        ...
        <div class="col-lg-6">
            <div class="hero-card soft-shadow">
                ...
                <img class="w-100 rounded-4" src="{{ asset('assets/img/clinic-hero.jpg') }}" alt="Clinic">
                <div class="p-3">
